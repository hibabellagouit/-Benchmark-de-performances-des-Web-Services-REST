#!/usr/bin/env python3
"""
Générateur de Données pour le Benchmark d'API REST
Génère des fichiers CSV pour la commande COPY de PostgreSQL
- 2000 catégories (CAT0001..CAT2000)
- 100 000 articles (~50 par catégorie)
"""
...
# Composants pour la génération des noms de produits
...
def random_date(start_days_ago=365):
    """Génère un horodatage aléatoire dans les N derniers jours"""
...
def generate_category_name(idx):
    """Génère un nom de catégorie réaliste"""
...
def generate_item_name():
    """# Génère un nom d'article réaliste"""
    templates = [
...
def generate_categories():
    """# Génère le fichier CSV des catégories"""
...
def generate_items(num_categories):
    """# Génère le fichier CSV des articles avec distribution par catégorie"""
...
def generate_jmeter_data(num_categories, num_items):
    """# Génère les fichiers CSV pour les tests JMeter"""
...
def generate_statistics():
    """# Affiche les statistiques sur les données générées"""
    print("\n" + "="*60)
